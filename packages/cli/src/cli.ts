...
import type { ProviderName } from 'mindrx';
...
OPTIONS:
  ...
  -p, --provider    LLM provider (default: mindrx)
...
PROVIDERS:
  mindrx            Free hosted backend (no API key needed)
  openai            OpenAI API (requires OPENAI_API_KEY)
  anthropic         Anthropic API (requires ANTHROPIC_API_KEY)
  google            Google AI (requires GOOGLE_API_KEY)
